...
class Logits(nn.Cell):
    def __init__(self, num_classes=100, dropout_keep_prob=0.8):
...
class InceptionV3(nn.Cell):
    def __init__(self, num_classes=1000, is_training=False, has_bias=False, dropout_keep_prob=0.8, include_top=True):
