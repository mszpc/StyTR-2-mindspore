...
from models import StyTR, transformer
...
def get_arg():
    ...
    parser.add_argument('--decoder_path', type=str, default='save_models/decoder.ckpt')
    parser.add_argument('--trans_path', type=str, default='save_models/transformer.ckpt')
    parser.add_argument('--embedding_path', type=str, default='save_models/embedding.ckpt')
