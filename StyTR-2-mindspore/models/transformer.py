...
from models.model_utils import AdaptiveAvgPool2d
...
class Transformer(nn.Cell):
    def __init__(self, model_dim=512, heads=8, num_encoder_layers=3,
        ...
        # self.averagepooling = AdaptiveAvgPool2d((32,32),(18,18))
        self.pad = nn.Pad(paddings=((0, 0), (0, 0), (3, 3), (3, 3)), mode="REFLECT")
        self.averagepooling = nn.AvgPool2d(kernel_size=(3,3),stride=2)
    ...
    def construct(self, style, mask, content, pos_embed_c, pos_embed_s):
        ...
        content_pool = self.pad(content)
        content_pool = self.averagepooling(content_pool)
